...
public class RedisRepository implements CacheRepository {
  ...
  private RedisTemplate<String, Object> redisTemplate;
    private RedisRepository(RedisTemplate<String, Object> redisTemplate) {
      this.redisTemplate = redisTemplate;
    }
  
    public static RedisRepository of(RedisTemplate<String, Object> redisTemplate) {
      checkNull(redisTemplate);
...
//
    ...
    private static void checkNull(Object key) {
